...
const Hero = () => {
  ...
  return (
    <section className="min-h-0 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-20 pb-8 sm:pt-24 sm:pb-10 relative z-10">
